 ...
 * @author Usuario
 */
public class GestionArbitrosVista extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GestionArbitrosVista.class.getName());
    private controlador.ControladorGestionEntrenadores controlador;

    /**
     * Creates new form GestionArbitrosVista
     */
    public GestionArbitrosVista() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GestionArbitrosVista().setVisible(true));
    }
